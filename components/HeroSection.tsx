...
export function HeroSection() {
  return (
    <section className="relative w-full overflow-hidden bg-hub-ink pt-20 text-white sm:pt-24 lg:pt-28">
      ...
      <div className="relative mx-auto w-full max-w-[min(1400px,calc(100vw-3rem))] px-6 pb-16 pt-3 sm:px-10 sm:pb-20 md:px-14 lg:px-16 lg:pb-24">
        <div className="grid items-center gap-14 lg:grid-cols-[1fr_min(380px,34vw)] lg:gap-16 xl:grid-cols-[1fr_400px]">
          <div className="text-center lg:text-left">
            ...
            <motion.h1
              ...
              className="mt-5 text-[clamp(2.6rem,5.9vw,4.65rem)] font-extrabold leading-[0.98] tracking-[-0.04em] text-white"
            >
            ...
            <motion.p
              ...
              className="mx-auto mt-6 max-w-2xl text-xl font-medium leading-snug tracking-[-0.015em] text-white/88 lg:mx-0 lg:text-[1.85rem]"
            >
            ...
            <p className="mt-6 text-center text-xs font-medium tracking-wide text-white/45 lg:text-left">
